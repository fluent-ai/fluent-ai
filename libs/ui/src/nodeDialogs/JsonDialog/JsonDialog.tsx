...
function JsonDialog({nodeId}:{nodeId:string}) {
  ...
  const inputModes = [
    {
      ...
      label:'Simple',
      description:
      <p>Processes the contents of msg.payload</p>
    },
    {
      value:'custom',
      label:'Custom Path',
  ...
  const outputModes = [
    {
      ...
      label:'Simple',
      description:
      <p>Saves the result to msg.payload</p>
    },
    {
      value:'custom',
      label:'Custom Path',
  ...
  if (inputs?.inputPath === undefined) {
    dispatch(flowActions.setInput({id:nodeId, nodeInputs:{...inputs,inputPath:'msg.payload'}}))
  }
  if (inputs?.outputPath === undefined) {
    dispatch(flowActions.setInput({id:nodeId, nodeInputs:{...inputs,outputPath:'msg.payload'}}))
  }
