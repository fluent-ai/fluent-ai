...
function PreviewDialog({ nodeId }: { nodeId: string }) {
    ...
    if (inputs?.titlePath === undefined) {
      dispatch(
        flowActions.setInput({
          id: nodeId,
          nodeInputs: { ...inputs, titlePath: 'msg.payload' },
        })
      );
    }
  ...
  const titleModes = [
    ...
    },
    {
      ...
      description: (
        <div>
          <p>
            Displays a property from the <code>msg</code> object
          </p>
        </div>
      ),
    },
  ...
  const dialogModes = [
    {
      ...
      description: (
        <p>
          Displays the contents of <code>msg.payload</code>
        </p>
      ),
    },
    {
      ...
      description: (
        <div>
          <p>
            displays the complete <code>msg</code> object
          </p>
        </div>
      ),
    },
  ...
  return (
    <InnerDialogStructure title="Preview" description="preview description">
      <div title="Preview">
        {display ? (
          <pre>
            <code>
