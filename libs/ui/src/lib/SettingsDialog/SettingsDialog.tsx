...
function SettingsDialog(props: SettingsDialogProps) {
  ...
  return (
    ...
    >
      <div>
          <p><b>Remote Code Runner</b></p>
          <p>Enabled</p>
          <Switch
          size={'medium'}
          label={""}
          checked={remoteRunnerState.enabled}
          onCheckedChange={(value) => {dispatch(generalActions.setRemoteRunnerEnabled(value))} }
          />
          <p>IP Address</p>
          <input
            ...
            onChange={(event) => dispatch(generalActions.setRemoteRunnerIp(event.target.value))}
          />
          <p>Port</p>
          <input
            className={styles.TextInput}
            ...
            onChange={(event) => dispatch(generalActions.setRemoteRunnerPort(Number(event.target.value)))}
          />
          <p>Status</p>
