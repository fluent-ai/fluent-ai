...
export const NodeData = {
  textFileInput:
    {label:'Text File Input', icon:<BsFiletypeTxt />},
  textInput:
    {label:'Text Input', icon:<RiText/>},
  json:
    {label:'JSON', icon:<TbJson />},
  userFunction:
    {label:'User Function', icon:<AiOutlineFunction />},
  template:
    {label:'Template', icon:<TbTemplate />},
  preview:
    {label:'Preview', icon:<MdPreview />},
  openAi:
    {label:'OpenAI', icon:<SiOpenai />},
  deepl:
    {label:'DeepL', icon:<DeeplLogo />},
  imageAi:
    {label:'Image AI', icon:<BiImages />},
  dalleGeneration:
    {label:'Dall.e Generation', icon:<BiImageAdd />},
  download:
...
//   const flows = store.getState().flowTab.flowTabs;
//   console.log(flows)
...
//         switch (label) {
//           case 'textFileInput':
//             return {label:'Text File Input', icon:<BsFiletypeTxt />};
//           case 'textInput':
//             return {label:'Text Input', icon:<RiText/>};
//           case 'json':
//             return {label:'JSON', icon:<TbJson />};
//           case 'userFunction':
//             return {label:'User Function', icon:<AiOutlineFunction />};
//           case 'template':
//             return {label:'Template', icon:<TbTemplate />};
//           case 'preview':
//             return {label:'Preview', icon:<MdPreview />};
//           case 'openAi':
//             return {label:'OpenAI', icon:<SiOpenai />};
//           case 'deepl':
//             return {label:'DeepL', icon:<DeeplLogo />};
//           case 'imageAi':
//             return {label:'Image AI', icon:<BiImages />};
//           case 'dalleGeneration':
//             return {label:'Dall.e Generation', icon:<BiImageAdd />};
//           case 'download':
//             return {label:'Download', icon:<BsDownload />};
//           default:
//             return null;
//         }
//       }
