...
import { supabaseActions, supabaseSelectors } from '@tool-ai/state';
...
const Header = (): JSX.Element => {
  ...
  return (
    ...
    >
      <aside
        className={`rounded-md bg-white shadow-md w-[45px] overflow-x-hidden transition-all duration-300 ease-in-out group-hover:w-60`}
      >
